...
public class MonitoringAoActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
...
//    FloatingActionButton fb_advanced_search;
    ...
    int uid,no_pegawai;
    String namaCabang, kodeSkk;


    Call<ParseResponse> call;
    private SearchView searchView;
    List<AoMonitoring> dataNasabah;
    SummaryMonitoring dataTotalMonitoring;
    AdapterMonitoringAo adapterMonitoringAo;
    ...
    public void main(){
        ...
        kodeSkk =getIntent().getStringExtra("kodeSkk");

        if(namaCabang!=null){
            AppUtil.toolbarRegular(this, "Monitoring AO "+namaCabang);
        }
        else{
            AppUtil.toolbarRegular(this, "Monitoring AO "+apppref.getNamaKantor().toUpperCase());
        }
    ...
    public void loadData(){
        ...
        call = apiClientAdapter.getApiInterface().listMonitoringAo(req);
...
//                    AppUtil.tutorialOverlay(PerformanceAoActivity.this,bt_tampil_summary,"Sekarang anda dapat melihat summary performance pembiayaan","tutorial_summary_performance");
                    ...
                    if(response.body().getStatus().equalsIgnoreCase("00")){
                        ...
                        String listDataString = response.body().getData().get("listAo").toString();
                        String listTotalString = response.body().getData().get("summary").toString();
                        Gson gson = new Gson();
                        Type type = new TypeToken<List<AoMonitoring>>() {}.getType();
                        ...
                        adapterMonitoringAo = new AdapterMonitoringAo(MonitoringAoActivity.this, dataNasabah);
                        rv_list_monitoring_pencairan.setLayoutManager(new LinearLayoutManager(MonitoringAoActivity.this));
                        rv_list_monitoring_pencairan.setItemAnimator(new DefaultItemAnimator());
                        rv_list_monitoring_pencairan.setAdapter(adapterMonitoringAo);

                        if(dataTotalMonitoring!=null){
                            setData();
                        }
                        else{
                            AppUtil.notiferror(MonitoringAoActivity.this, findViewById(android.R.id.content), "Terjadi kesalahan pada data Summary");
                        }
                        ...
                        AppUtil.notiferror(MonitoringAoActivity.this, findViewById(android.R.id.content), response.body().getMessage());
                    }
                }
            }
            ...
            public void onFailure(Call<ParseResponse> call, Throwable t) {
                ...
                AppUtil.notiferror(MonitoringAoActivity.this, findViewById(android.R.id.content), "Terjadi kesalahan pada server");
            }
        });
    }
    ...
    public void onRefresh() {
        ...
        MonitoringAoActivity.this.recreate();
    }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setQueryHint("Nama AO, Produk, dll ..");
    ...
    private void searchPipeline(){
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextSubmit(String query) {
                adapterMonitoringAo.getFilter().filter(query);
                return false;
            }
    ...
    private void otherViewChanges(){
        ...
        if(namaCabang!=null){
            tv_keterangan_summary.setText("Summary Pencapaian : "+namaCabang);
        }
        else{
