package com.application.bris.brisi_pemutus.page_konsumer_kmg.kelengkapan_dokumen;
...
public class KelengkapanDokumenKonsumerKmgActivity extends AppCompatActivity {
    ...
    @BindView(R.id.cv_sk_pegawai_tetap)
    CardView cv_sk_pegawai_tetap;
    @BindView(R.id.cb_sk_pegawai_tetap)
    CheckBox cb_sk_pegawai_tetap;
    @BindView(R.id.tv_sk_pegawai_tetap)
    TextView tv_sk_pegawai_tetap;
    ...
    @BindView(R.id.cv_surat_kuasa_debet)
    CardView cv_surat_kuasa_debet;
    @BindView(R.id.cb_surat_kuasa_debet)
    CheckBox cb_surat_kuasa_debet;
    @BindView(R.id.tv_surat_kuasa_debet)
    TextView tv_surat_kuasa_debet;
    ...
    @BindView(R.id.cv_kwitansi)
    CardView cv_kwitansi;
    ...
    @BindView(R.id.bt_sk_pegawai_tetap)
    Button bt_sk_pegawai_tetap;
    ...
    Button bt_skpg;
    @BindView(R.id.bt_surat_kuasa_debet)
    Button bt_surat_kuasa_debet;
    @BindView(R.id.bt_sk_penghasilan)
    Button bt_sk_penghasilan;
    @BindView(R.id.bt_rek_koran)
    Button bt_rek_koran;
    @BindView(R.id.bt_kwitansi)
    Button bt_kwitansi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.kelengkapan_dokumen_kmg_activity);
...
//        kalau belum dilihat semua, gak bisa di putus
        ...
        bt_lanjut_kelengkapan_data.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(KelengkapanDokumenKonsumerKmgActivity.this, CatatanActivity.class);
    ...
    public void main(){
        ...
        backToolbar.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(KelengkapanDokumenKonsumerKmgActivity.this, PutusanFrontMenuKmg.class);
        ...
        bt_ktp_kelengkapan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent=new Intent(KelengkapanDokumenKonsumerKmgActivity.this, ActivityFotoKelengkapanDokumen.class);
                startActivity(intent);
            }
        });
...
//                            }
                            ...
                            if(dataKelengkapan.getSURAT_KETERANGAN_PEGAWAI_TETAP()){
                                cb_sk_pegawai_tetap.setChecked(true);
                                bt_sk_pegawai_tetap.setVisibility(View.VISIBLE);
                            }
                            else{
                                cb_sk_pegawai_tetap.setChecked(false);
                                bt_sk_pegawai_tetap.setVisibility(View.GONE);
                            }
                            ...
                            if(dataKelengkapan.getSURAT_REKOMENDASI()){
                            ...
                            if(dataKelengkapan.getSURAT_KUASA_POTONG_GAJI()){
                            ...
                            if(dataKelengkapan.getSURAT_KUASA_DEBET_REKENING()){
                                cb_surat_kuasa_debet.setChecked(true);
                                bt_surat_kuasa_debet.setVisibility(View.VISIBLE);
                            }
                            else{
                                cb_surat_kuasa_debet.setChecked(false);
                                bt_surat_kuasa_debet.setVisibility(View.GONE);
                            }
                            ...
                            if(dataKelengkapan.getREKENING_KORAN()){
                            ...
                            if(dataKelengkapan.getKWITANSI_PEMBELIAN_BARANG_JASA()){
                                cb_kwitansi.setChecked(true);
                                bt_kwitansi.setVisibility(View.VISIBLE);
                            }
                            else{
                                cb_kwitansi.setChecked(false);
                                bt_kwitansi.setVisibility(View.GONE);
                            }
...
//                            rv_agunan_kelengkapan.setAdapter(adapterKelengkapanDokumenAgunan);
                            ...
                            try{
                                ...
                                onClickLihatFoto(bt_surat_kuasa_debet, dataKelengkapan.getID_DOKUMEN_SURAT_KUASA_DEBET_REKENING());

                                //start onclick lihat pdf
                                onClickLihatPdf(bt_surat_nikah_kelengkapan, dataKelengkapan.getID_DOKUMEN_SURAT_NIKAH());
                                onClickLihatPdf(bt_sk_pegawai_tetap, dataKelengkapan.getID_DOKUMEN_SURAT_KETERANGAN_PEGAWAI_TETAP());
                                ...
                                onClickLihatPdf(bt_kwitansi, dataKelengkapan.getID_DOKUMEN_KWITANSI_PEMBELIAN_BARANG_JASA());
                            ...
                            AppUtil.notiferror(KelengkapanDokumenKonsumerKmgActivity.this, findViewById(android.R.id.content), response.body().getMessage());
                            finish();
                        }
                    }
                    else {
            ...
            public void onFailure(Call<ParseResponse> call, Throwable t) {
                loading.setVisibility(View.GONE);
                AppUtil.notiferror(KelengkapanDokumenKonsumerKmgActivity.this, findViewById(android.R.id.content), "Terjadi kesalahan");
                finish();
            }
        });
    ...
    private void onClickLihatFoto(Button butt, final int id_foto){
        butt.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent=new Intent(KelengkapanDokumenKonsumerKmgActivity.this, ActivityPreviewFotoSecondary.class);
        ...
        butt.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    ...
                    AlertDialog.Builder builder = new AlertDialog.Builder(KelengkapanDokumenKonsumerKmgActivity.this);
