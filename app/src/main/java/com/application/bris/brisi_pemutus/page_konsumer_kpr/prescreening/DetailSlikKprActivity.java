...
import com.application.bris.brisi_pemutus.page_putusan.detail_slik.FragmentSlikNasabah;
import com.application.bris.brisi_pemutus.page_putusan.detail_slik.FragmentSlikPasangan;
...
public class DetailSlikKprActivity extends AppCompatActivity {
    ...
    DetailSlikKprActivity.ViewPagerAdapter adapter = new DetailSlikKprActivity.ViewPagerAdapter(getSupportFragmentManager());
...
//        Log.d("slikaplikasi",Integer.toString(idAplikasi));
    ...
    private void loadData() {
        ...
        req.setIdAplikasi(idAplikasi);
            ...
            call = apiClientAdapter.getApiInterface().inquiryRemaksSlikKpr(req);
        ...
        call.enqueue(new Callback<ParseResponse>() {
                ...
                try {
                    if (response.isSuccessful()){
                        if (response.body().getStatus().equalsIgnoreCase("00")){
                            ...
                            AppUtil.notiferror(DetailSlikKprActivity.this, findViewById(android.R.id.content), response.body().getMessage());
                            finish();
                        }
                    }
                    else {
            ...
            public void onFailure(Call<ParseResponse> call, Throwable t) {
                loading.setVisibility(View.GONE);
                AppUtil.notiferror(DetailSlikKprActivity.this, findViewById(android.R.id.content), "Terjadi kesalahan");
                finish();
            }
        });
