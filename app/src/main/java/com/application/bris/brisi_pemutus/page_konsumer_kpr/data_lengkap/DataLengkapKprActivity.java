...
public class DataLengkapKprActivity extends AppCompatActivity implements StepperLayout.StepperListener{
...
//        appPreferences.setReadDataLengkap("yes");
        ...
        backToolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DataLengkapKprActivity.this, PutusanFrontMenuKpr.class);
...
//        Toasty.info(DataLengkapKprActivity.this,"id aplikasi masih hardcoded").show();

            call = apiClientAdapter.getApiInterface().inquiryDataLengkapKpr(req);
                ...
                try {
                    if (response.isSuccessful()){
                        ...
                        if(response.body().getStatus().equalsIgnoreCase("00")){
                            ...
                            dataLengkap = gson.fromJson(dataPribadiString, DataLengkapKpr.class);
                            stepperlayout.setAdapter(new DataLengkapKprStepAdapter(getSupportFragmentManager(), DataLengkapKprActivity.this, dataLengkap), startingStepPosition );
    ...
    public void onCompleted(View view) {
        ...
        Intent intent = new Intent(DataLengkapKprActivity.this, PrescreeningKprActivity.class);
