package com.application.bris.brisi_pemutus.model.data_lengkap;

import com.google.gson.annotations.Expose;
import com.google.gson.annotations.SerializedName;

public class DataLengkapKpr {
    ...
    @SerializedName("jenisPekerjaanDesc")
    @Expose
    private String jenisPekerjaanDesc;

    @SerializedName("detilJenisPekerjaanDesc")
    @Expose
    private String detilJenisPekerjaanDesc;

    public String getJenisPekerjaanDesc() {
        return jenisPekerjaanDesc;
    }

    public void setJenisPekerjaanDesc(String jenisPekerjaanDesc) {
        this.jenisPekerjaanDesc = jenisPekerjaanDesc;
    }

    public String getDetilJenisPekerjaanDesc() {
        return detilJenisPekerjaanDesc;
    }

    public void setDetilJenisPekerjaanDesc(String detilJenisPekerjaanDesc) {
        this.detilJenisPekerjaanDesc = detilJenisPekerjaanDesc;
    }
