package com.application.bris.brisi_pemutus.page_konsumer_kpr;
...
import com.application.bris.brisi_pemutus.page_konsumer_kpr.sektor_ekonomi.SektorEkonomiKprActivity;
...
public class PutusanFrontMenuKpr extends AppCompatActivity {
    ...
    DetailHotprospekKpr detailHotprospek;
    ...
    @BindView(R.id.rl_agunan)
    RelativeLayout rl_agunan;

    @BindView(R.id.rl_scoring)
    RelativeLayout rl_scoring;

    @BindView(R.id.ll_baris_3_kpr)
    LinearLayout ll_baris_3_kpr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.putusan_front_menu_kpr_ao_silang);
        apiClientAdapter = new ApiClientAdapter(PutusanFrontMenuKpr.this);
        appPreferences=new AppPreferences(this);

        //membuat kondisi preference dalam kondisi default, tidak ada yang diceklis kecuali agunan
//        setFrontPreferenceDefault();
        setFrontPreferenceKpr();

        ButterKnife.bind(this);
        setSupportActionBar(tb_regular);
        AppUtil.toolbarRegular(this, "Detail Nasabah Appraisal");
        ...
        backToolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(getIntent().getSerializableExtra("data_putusan_akad")!=null){
                    Intent intent=new Intent(PutusanFrontMenuKpr.this, ActivityMenuRiwayat.class);
                    intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT );
                    startActivity(intent);
                }
                else if(dataPutusan!=null&&dataPutusan.getFid_status().equalsIgnoreCase("14")){
                    SweetAlertDialog dialogWarning=new SweetAlertDialog(PutusanFrontMenuKpr.this,SweetAlertDialog.WARNING_TYPE);
                    dialogWarning.setTitle("Putusan Belum Dilakukan");
                    dialogWarning.setContentText("Anda belum melakukan putusan, apakah anda yakin ingin kembali ke menu awal?\n");
                    ...
                    dialogWarning.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                        ...
                        public void onClick(SweetAlertDialog sweetAlertDialog) {
                            Intent intent=new Intent(PutusanFrontMenuKpr.this, MenuDaftarPutusanActivity.class);
                            intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT );
                            startActivity(intent);
                        }
                    });
                    ...
                    SweetAlertDialog dialogWarning=new SweetAlertDialog(PutusanFrontMenuKpr.this,SweetAlertDialog.WARNING_TYPE);
                    dialogWarning.setTitle("AO silang belum dipilih");
                    dialogWarning.setContentText("Anda belum memilih AO silang, apakah anda yakin ingin kembali ke menu awal?\n");
                    dialogWarning.setCancelText("Batal");
                    dialogWarning.setConfirmText("Ya");
                    dialogWarning.setConfirmClickListener(new SweetAlertDialog.OnSweetClickListener() {
                        @Override
                        public void onClick(SweetAlertDialog sweetAlertDialog) {
                            Intent intent=new Intent(PutusanFrontMenuKpr.this, AoSilangActivity.class);
                            intent.addFlags(Intent.FLAG_ACTIVITY_REORDER_TO_FRONT );
                            startActivity(intent);
                        }
                    });
...
//            Log.d("datasdeviasifront",dataPutusan.getFid_photo());
            ...
            iv_foto_putusan_front.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(PutusanFrontMenuKpr.this, ActivityFotoKelengkapanDokumen.class);
        ...
        datalengkap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent;
                    ...
                    intent = new Intent(PutusanFrontMenuKpr.this, DataLengkapKprActivity.class);
...
//                intent.putExtra("plafond", "2500000");
        ...
        history.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PutusanFrontMenuKpr.this, HistoryActivity.class);
                intent.putExtra("cif", cif_syiar.getText());
        ...
        agunan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(PutusanFrontMenuKpr.this, AgunanTerikatActivity.class);
...
//                intent.putExtra("idAplikasi", "101694");
        ...
        prescreening.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PutusanFrontMenuKpr.this, PrescreeningKprActivity.class);
                intent.putExtra("idAplikasi", id_aplikasi.getText());
                intent.putExtra("superData",superData);
        ...
        sektor_ekonomi.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PutusanFrontMenuKpr.this, SektorEkonomiKprActivity.class);

                //real data
                if(detailHotprospek.getIdProgram()!=null&&!detailHotprospek.getIdProgram().isEmpty()){
                    intent.putExtra("idProgram", detailHotprospek.getIdProgram());
                }
                ...
                intent.putExtra("jenisPembiayaan", "kpr");//identifier kalau ke sektor ekonomi kmg
                intent.putExtra("superData",superData);
...
//                intent.putExtra("tujuanPembiayaan", "Barang Modal");
        ...
        scoring.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PutusanFrontMenuKpr.this, ScoringKprActivity.class);
...
//                intent.putExtra("idAplikasi", 101694);
        ...
        btPutusan.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(superData.getFidStatus().equalsIgnoreCase("14")) {
                    ...
                    if (appPreferences.getReadKelengkapan().equalsIgnoreCase("no") || appPreferences.getReadPreScreening().equalsIgnoreCase("no") || appPreferences.getReadDataLengkap().equalsIgnoreCase("no") || appPreferences.getReadSektorEkonomi().equalsIgnoreCase("no") || appPreferences.getReadDataFinansial().equalsIgnoreCase("no") || appPreferences.getReadScoring().equalsIgnoreCase("no")) {
                        Toasty.info(PutusanFrontMenuKpr.this, "Harus melihat seluruh data nasabah sebelum memutus").show();
                    } else {
                        Intent intent = new Intent(PutusanFrontMenuKpr.this, CatatanActivity.class);
                        intent.putExtra("cif", cif_syiar.getText());
                        intent.putExtra("idAplikasi", Integer.parseInt(id_aplikasi.getText().toString()));
                        ...
                        Intent intent = new Intent(PutusanFrontMenuKpr.this, KonsumerKPRPilihAoSilangActivity.class);
                        intent.putExtra("cif", cif_syiar.getText());
                        intent.putExtra("idAplikasi", Integer.parseInt(id_aplikasi.getText().toString()));
//                        intent.putExtra("fidStatus", dataPutusan.getFid_status());
//                        intent.putExtra("superData", superData);
                        startActivity(intent);
//                    Toasty.info(PutusanFrontMenuKpr.this, "Tadaam...anggap aja masuk ke halaman AO Silang").show();
        ...
        Glide.with(PutusanFrontMenuKpr.this)
...
//                    Toast.makeText(PutusanFrontMenuKmg.this, "Hardcode purna, PUTUSAN FRONT MENU KMG  425", Toast.LENGTH_SHORT).show();
        ...
        agunan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
//                Toasty.info(PutusanFrontMenuKpr.this,"Pembiayaan beragun SK").show();
                Intent intent = new Intent(PutusanFrontMenuKpr.this, AgunanTerikatActivity.class);
                intent.putExtra("cif", cif_syiar.getText());
                intent.putExtra("idAplikasi", id_aplikasi.getText()).toString();
                intent.putExtra("idAgunan", dataPutusan.getFid_agunan());
...
//                intent.putExtra("idAplikasi", "101694");
    ...
    private void cekAdaCs(final SweetAlertDialog dialog1){
        ...
        AppPreferences appPreferences = new AppPreferences(PutusanFrontMenuKpr.this);
...
//        produk.setText(dataPutusanAkad.getNAMA_PRODUK());
    ...
    private void setFrontPreferenceKpr(){
        appPreferences.setReadPreScreening("no");
        appPreferences.setReadDataLengkap("no");
        appPreferences.setReadSektorEkonomi("no");
        appPreferences.setReadDataFinansial("no");
...
//        super.onBackPressed();
    ...
    private void loadDataHotprospek(int idAplikasi) {
        ...
        Call<ParseResponse> call ;
                ...
                call = apiClientAdapter.getApiInterface().detailHotprospekKpr(req);
                ...
                try {
                    if (response.isSuccessful()){
                        if(response.body().getStatus().equalsIgnoreCase("00"))
                        {
                            ...
                            detailHotprospek = gson.fromJson(dataString, DetailHotprospekKpr.class);
                            ...
                            AppUtil.notiferror(PutusanFrontMenuKpr.this, findViewById(android.R.id.content), response.body().getMessage());
...
//                            }, 2000);
                        ...
                        AppUtil.notiferror(PutusanFrontMenuKpr.this, findViewById(android.R.id.content), error.getMessage());
//                        new Handler().postDelayed(new Runnable() {
//                            @Override
//                            public void run() {
//                                finish();
...
//                    }, 2000);
            ...
            public void onFailure(Call<ParseResponse> call, Throwable t) {
                loading.setVisibility(View.GONE);
                AppUtil.notiferror(PutusanFrontMenuKpr.this, findViewById(android.R.id.content), getString(R.string.txt_connection_failure));
//                new Handler().postDelayed(new Runnable() {
//                    @Override
//                    public void run() {
//                        finish();
...
//                }, 2000);
    ...
    private void otherViewChanges(){
        ...
        //kalau status aplikasi bukan "menunggu appraisal"
        if(dataPutusan!=null&&!dataPutusan.getFid_status().equalsIgnoreCase("163")){
            rl_agunan.setVisibility(View.VISIBLE);
            rl_scoring.setVisibility(View.VISIBLE);
            ll_baris_3_kpr.setVisibility(View.VISIBLE);

            btPutusan.setText("Lanjut ke Putusan");
        }else if(dataPutusanAkad!=null&&!dataPutusanAkad.getFid_status().equalsIgnoreCase("163")){
            rl_agunan.setVisibility(View.VISIBLE);
            rl_scoring.setVisibility(View.VISIBLE);
            ll_baris_3_kpr.setVisibility(View.VISIBLE);
