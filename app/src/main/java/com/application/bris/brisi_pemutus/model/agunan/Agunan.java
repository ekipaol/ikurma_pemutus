package com.application.bris.brisi_pemutus.model.agunan;
...
public class Agunan {
    ...
    @Expose
    private String hargaMeterTanah;
    ...
    private int idPhotoTBbangunan;
    @SerializedName("idPhotoTButara")
    private int idPhotoTButara;
    @SerializedName("idPhotoTBbarat")
    private int idPhotoTBbarat;
    @SerializedName("idPhotoTBselatan")
    private int idPhotoTBselatan;
    ...
    public void setIdPhotoTBbangunan(int idPhotoTBbangunan) {
        this.idPhotoTBbangunan = idPhotoTBbangunan;
    }

    public int getIdPhotoTButara() {
        return idPhotoTButara;
    }

    public void setIdPhotoTButara(int idPhotoTButara) {
        this.idPhotoTButara = idPhotoTButara;
    }

    public int getIdPhotoTBbarat() {
        return idPhotoTBbarat;
    }

    public void setIdPhotoTBbarat(int idPhotoTBbarat) {
        this.idPhotoTBbarat = idPhotoTBbarat;
    }

    public int getIdPhotoTBselatan() {
        return idPhotoTBselatan;
    }

    public void setIdPhotoTBselatan(int idPhotoTBselatan) {
        this.idPhotoTBselatan = idPhotoTBselatan;
    }

    public int getIdPhotoTBtimur() {
        return idPhotoTBtimur;
    }

    public void setIdPhotoTBtimur(int idPhotoTBtimur) {
        this.idPhotoTBtimur = idPhotoTBtimur;
    }

    public int getIdPhotoTBbpn() {
        return idPhotoTBbpn;
    }

    public void setIdPhotoTBbpn(int idPhotoTBbpn) {
...
//
    ...
    public String getHargaMeterTanah() {
        return hargaMeterTanah;
    }

    public void setHargaMeterTanah(String hargaMeterTanah) {
