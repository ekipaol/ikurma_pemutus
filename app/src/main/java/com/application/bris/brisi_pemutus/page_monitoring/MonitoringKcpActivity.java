...
public class MonitoringKcpActivity extends AppCompatActivity implements SwipeRefreshLayout.OnRefreshListener{
...
//    FloatingActionButton fb_advanced_search;
    ...
    List<KcpMonitoring> dataCabang;
    SummaryMonitoring dataTotalMonitoring;
    AdapterMonitoringKcp adapterMonitoringKcp;
    ...
    public void main(){
        ...
        //nama topbar diganti berdasarkan user KP atau bukan
        if(apppref.getFidRole().equalsIgnoreCase("84")){
            AppUtil.toolbarRegular(this, "Monitoring "+getIntent().getStringExtra("namaCabang"));
        }
        else{
    ...
    public void loadData(){
        ...
        //kalau yang login KP, berarti ambil SKK dari intent bukan dari preferences
        if(apppref.getFidRole().equalsIgnoreCase("84")){
            req.setKodeSkk(getIntent().getStringExtra("kodeSkk"));
        }
        else{
        ...
        call = apiClientAdapter.getApiInterface().listMonitoringKcp(req);
...
//                    AppUtil.tutorialOverlay(PerformanceAoActivity.this,bt_tampil_summary,"Sekarang anda dapat melihat summary performance pembiayaan","tutorial_summary_performance");
                    ...
                    if(response.body().getStatus().equalsIgnoreCase("00")){
                        ...
                        String listDataString = response.body().getData().get("listCabang").toString();
                        String listTotalString = response.body().getData().get("summary").toString();
                        Gson gson = new Gson();
                        Type type = new TypeToken<List<KcpMonitoring>>() {}.getType();
                        ...
                        if(dataTotalMonitoring!=null){
                            ...
                            AppUtil.notiferror(MonitoringKcpActivity.this, findViewById(android.R.id.content), "Terjadi kesalahan pada data Summary");
                        }
                        ...
                        AppUtil.notiferror(MonitoringKcpActivity.this, findViewById(android.R.id.content), response.body().getMessage());
                    }
                }
            }
            ...
            public void onFailure(Call<ParseResponse> call, Throwable t) {
                ...
                AppUtil.notiferror(MonitoringKcpActivity.this, findViewById(android.R.id.content), "Terjadi kesalahan pada server");
            }
        });
    }
    ...
    public void onRefresh() {
        ...
        MonitoringKcpActivity.this.recreate();
    }
