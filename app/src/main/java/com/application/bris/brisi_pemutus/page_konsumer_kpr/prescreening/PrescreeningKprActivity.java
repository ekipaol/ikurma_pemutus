package com.application.bris.brisi_pemutus.page_konsumer_kpr.prescreening;
...
public class PrescreeningKprActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backToolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    Intent intent = new Intent(PrescreeningKprActivity.this, PutusanFrontMenuKpr.class);
        ...
        bt_lanjut_data_lengkap.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    Intent intent=new Intent(PrescreeningKprActivity.this, SektorEkonomiKprActivity.class);
        ...
        btn_detailslik.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(PrescreeningKprActivity.this, DetailSlikActivity.class);
...
//        req.setId_aplikasi(101678);
            ...
            call = apiClientAdapter.getApiInterface().inquiryPrescreeningKpr(req);
...
//                            Log.d("preyscreeningstring",dataKelengkapanString);
                            ...
                            //tutorial overlay
//                            AppUtil.tutorialOverlay(PrescreeningKprActivity.this,btn_detailslik,"Lihat hasil remark pemrakarsa terhadap SLIK nasabah melalui tombol ini","tutorial_prescreening_detail_slik");
            ...
            public void onFailure(Call<ParseResponse> call, Throwable t) {
                loading.setVisibility(View.GONE);
                AppUtil.notiferror(PrescreeningKprActivity.this, findViewById(android.R.id.content), "Terjadi kesalahan");
                finish();
            }
        });
...
//       tv_loading.setText("Downloading...");
        dialog=new SweetAlertDialog(PrescreeningKprActivity.this,SweetAlertDialog.PROGRESS_TYPE);
                    ...
                    if (response.isSuccessful()){
                        if(response.body().getStatus().equalsIgnoreCase("00"))
                        {
                            ...
                            if(dataString.length()<=50){
                                AppUtil.notiferror(PrescreeningKprActivity.this, findViewById(android.R.id.content), "PDF tidak ditemukan");
                            }
                            else{
                                byte[] data = Base64.decode(dataString, Base64.DEFAULT);
                                new DownloadTask(PrescreeningKprActivity.this, data, fileName);
                                final SweetAlertDialog dialog=new SweetAlertDialog(PrescreeningKprActivity.this,SweetAlertDialog.NORMAL_TYPE);
