...
public class DataLkn {
    ...
    public Object iNTERVALIRREGULAR;
    ...
    public String FID_PHOTO_DEPAN;
    @SerializedName("FID_PHOTO_DALAM")
    public String FID_PHOTO_DALAM;
    ...
    public String getFID_PHOTO_DEPAN() {
        return FID_PHOTO_DEPAN;
    }

    public void setFID_PHOTO_DEPAN(String FID_PHOTO_DEPAN) {
        this.FID_PHOTO_DEPAN = FID_PHOTO_DEPAN;
    }

    public String getFID_PHOTO_DALAM() {
        return FID_PHOTO_DALAM;
    }

    public void setFID_PHOTO_DALAM(String FID_PHOTO_DALAM) {
        this.FID_PHOTO_DALAM = FID_PHOTO_DALAM;
    }

    public String getFID_PHOTO_LINGKUNGAN() {
        return FID_PHOTO_LINGKUNGAN;
    }

    public void setFID_PHOTO_LINGKUNGAN(String FID_PHOTO_LINGKUNGAN) {
        this.FID_PHOTO_LINGKUNGAN = FID_PHOTO_LINGKUNGAN;
    }
    ...
    public Object getjENISANGSURAN() {
    ...
    public String gettOTALEKSPOSUREBRIS() {
    ...
    public Object getiNTERVALIRREGULAR() {
