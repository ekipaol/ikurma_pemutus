package com.application.bris.brisi_pemutus.page_konsumer_kmg.scoring;
...
public class ScoringKonsumerKmgActivity extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        backToolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(ScoringKonsumerKmgActivity.this, PutusanFrontMenuKmg.class);
...
//        req.setCif(81862);
//        Toasty.info(ScoringKonsumerKmgActivity.this,"Id aplikasi masih hardcode").show();
        ...
        if(superData.getKodeProduk().equalsIgnoreCase("428")){
            ...
            call = apiClientAdapter.getApiInterface().inquiryScoringKmg(req);
        }
...
//                            });
                        ...
                        AppUtil.notiferror(ScoringKonsumerKmgActivity.this, findViewById(android.R.id.content), error.getMessage());
                    }
                }
                catch (Exception e){
                    e.printStackTrace();
            ...
            public void onFailure(Call<ParseResponse> call, Throwable t) {
                AppUtil.notiferror(ScoringKonsumerKmgActivity.this, findViewById(android.R.id.content), getString(R.string.txt_connection_failure));
            }
        });
    }
}
