...
public class DataFinansialFlppActivity extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.konsumer_data_finansial_flpp);
...
//        getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_ADJUST_PAN);
        ...
        backToolbar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(DataFinansialFlppActivity.this, PutusanFrontMenuKpr.class);
        ...
        bt_lanjut_data_finansial.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DataFinansialFlppActivity.this, AgunanTerikatActivity.class);
...
//        et_margin_pertahun.setFocusable(false);
        ...
        et_joint_income.setFocusable(false);
        et_nominal_uang_muka.setFocusable(false);
...
//        valBd_grossProfitMargin = (valBd_pendapatanUsaha.subtract(valBd_hargapokokPenjualan)).divide(valBd_pendapatanUsaha, 2, RoundingMode.HALF_UP).multiply(new BigDecimal(100)).setScale(1, BigDecimal.ROUND_HALF_UP);
        ...
        et_joint_income.setText(dataFinansial.getJOINT_INCOME());
...
//                            et_angsuran.setText(String.valueOf(Angsuran));
        ...
        et_jumlah_plafon_pembiayaan_diusulkan.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus && et_jangka_waktu.getText().toString().isEmpty()) {
                    ...
                    AppUtil.notiferror(DataFinansialFlppActivity.this, findViewById(R.id.content), "Harap isi jangka waktu sebelum mengubah plafon diusulkan");
                ...
                if (hasFocus && et_margin_pertahun.getText().toString().isEmpty()) {
                    ...
                    AppUtil.notiferror(DataFinansialFlppActivity.this, findViewById(R.id.content), "Harap isi margin sebelum mengubah plafon diusulkan");
                    Log.d("ekiduper"," masuk kedalam non takeover");
                }
        ...
        et_jangka_waktu.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (s != null && s.length() > 0 && Integer.parseInt(s.toString()) != 0) {
                    ...
                    if (s.length() > 0) {
                        Toast.makeText(DataFinansialFlppActivity.this, "Jangka waktu tidak boleh 0 ", Toast.LENGTH_SHORT).show();
    ...
    public void loadData() {
        ...
        Call<ParseResponse> call = apiClientAdapter.getApiInterface().inquiryDataFinansialKprFlpp(req);
        call.enqueue(new Callback<ParseResponse>() {
            @Override
            public void onResponse(Call<ParseResponse> call, Response<ParseResponse> response) {
                try {
                    if (response.isSuccessful()) {
//                            Toast.makeText(DataFinansialFlppActivity.this, "Id aplikasi masih hardcode", Toast.LENGTH_SHORT).show();
...
//                                Log.d("firmansah isdebest",dataFinansial.getoMZETPERBULAN());
                            ...
                            loading.setVisibility(View.GONE);
                            AppUtil.notiferror(DataFinansialFlppActivity.this, findViewById(android.R.id.content), response.body().getMessage());
                        }
                    } else {
                        loading.setVisibility(View.GONE);
                        Error error = ParseResponseError.confirmEror(response.errorBody());
                        AppUtil.notiferror(DataFinansialFlppActivity.this, findViewById(android.R.id.content), error.getMessage());
                    }
                } catch (Exception e) {
                    e.printStackTrace();
                }
            ...
            public void onFailure(Call<ParseResponse> call, Throwable t) {
                loading.setVisibility(View.GONE);
                AppUtil.notiferror(DataFinansialFlppActivity.this, findViewById(android.R.id.content), getString(R.string.txt_connection_failure));
            }
        });
